...

{
  config.homeManager.nixosModules = lib.mkAfter [
    ({ pkgs, ... }: {
      ...
      xdg.configFile."i3/wallpaper.jpeg".source = ../../dotfiles/i3/wallpaper.jpeg;
      xdg.configFile."i3/lock.sh" = {
        executable = true;
        source = ../../dotfiles/i3/lock.sh;
      };
      ...
      xdg.configFile."i3blocks/scripts/cpu" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/cpu;
      };
      xdg.configFile."i3blocks/scripts/date" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/date;
      };
      xdg.configFile."i3blocks/scripts/disk" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/disk;
      };
      xdg.configFile."i3blocks/scripts/memory" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/memory;
      };
      xdg.configFile."i3blocks/scripts/pango" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/pango;
      };
      xdg.configFile."i3blocks/scripts/volume" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/volume;
      };
      xdg.configFile."i3blocks/scripts/volume-pulseaudio" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/volume-pulseaudio;
      };
      xdg.configFile."i3blocks/scripts/weather" = {
        executable = true;
        source = ../../dotfiles/i3blocks-scripts/weather;
      };
    })
  ];
}
