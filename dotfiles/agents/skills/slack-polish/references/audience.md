...
Format for entries:
- **Name/handle** (`@user` or `#channel`): [level] — [brief context]
- Level options: `Técnico`, `Semi-técnico`, `No técnico`
...
- **Nacho**: `Semi-técnico` — Backend developer. Builds, dependencias Python (poetry, torch), resolución de problemas de entorno.
- **Santi**: `Semi-técnico` — Backend developer. Mismo stack que Nacho.

## Grupos

- **@ml-display-tls**: `Semi-técnico` — Grupo de Technical Leads del equipo Display. Superiores del usuario. Tono deferente, no pedir accionables directos.
- **@ml-display-pls**: `Semi-técnico` — Grupo de People/Product Leads del equipo Display. Superiores del usuario. Tono deferente, no pedir accionables directos.

## Canales

- **#dsp-ml-devs**: `Técnico` — Canal del equipo de desarrollo ML/backend. Audiencia de ingenieros, entiende toda la jerga técnica.
- **#dsp-bidder-ml**: `Técnico` — Visibilidad de procesos de bidding y budget. Audiencia técnica mixta del equipo DSP.
- **#dsp-ml-monitors** (C05D6AERCLB): `Semi-técnico` — Canal público de monitoreo, visible para toda la organización. Tono siempre formal y polite, evitar lenguaje muy interno o crudo.
