...
## Commit Messages
- NEVER add any mention of AI tools, agents, or co-author lines to commits.
- NEVER include any mention of Claude, Anthropic, OpenAI, or AI tools in commit messages, PR descriptions, code comments, or any project artifacts.
